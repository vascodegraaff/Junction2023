...
type NavigationLinkProps = {
  link: {
    ...
    trailingAction: (() => React.ReactNode) | null;
    isActive: boolean;
    isExternal: boolean;
  };
};

export const NavigationLink: React.FC<NavigationLinkProps> = ({ link }) => {

  const { href, label, icon: Icon, trailingAccessory: Accessory, trailingAction: Action, isActive, isExternal } = link
